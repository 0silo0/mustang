    ...
    <header className="header">
      ...
      <div className="mobile-menu" data-open={isMenuOpen}>
        ...
        <div className="mobile-menu-content">
          ...
          <Link href="/catalog" className="mobile-nav-link" onClick={closeMenu}>
            Каталог техники
          </Link>
          <Link href="/about" className="mobile-nav-link" onClick={closeMenu}>
            О компании
          </Link>
          <Link href="/contacts" className="mobile-nav-link" onClick={closeMenu}>
            Контакты
          </Link>
          ...
          <div className="mobile-contact">
            <a 
              ...
              target="_blank" 
              rel="noopener" 
              className="social-btn whatsapp-btn-header"
              onClick={closeMenu}
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener" 
              className="social-btn telegram-btn-header"
              onClick={closeMenu}
            >
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
